...
int ff_h264_decode_seq_parameter_set(GetBitContext *gb, AVCodecContext *avctx,//tiger h264 sps 解析
...
int ff_h264_decode_picture_parameter_set(GetBitContext *gb, AVCodecContext *avctx,//tiger h264 pps 解析
