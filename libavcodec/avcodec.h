 ...
 * equal.
 */
#define AV_CODEC_PROP_REORDER       (1 << 3)//tiger 允许重组
/**
...
enum AVDiscard{
    ...
    AVDISCARD_DEFAULT =  0, ///< discard useless packets like 0 size packets in avi//是否这个是最多的
...
typedef struct AVCodecContext {
    ...
    enum AVMediaType codec_type; /* see AVMEDIA_TYPE_xxx 音频，视频 字幕*/
